...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    "finance-desc": "Financial standing for fiscal year 2023",
  ...
  fil: {
    ...
    "finance-desc": "Sitwasyong pinansyal para sa taon 2023",
  ...
  ilo: {
    ...
    "finance-desc": "Kadawyan ti pinansia para iti fiscal a tawen 2023",
