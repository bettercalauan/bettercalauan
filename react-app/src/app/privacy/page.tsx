          ...
          <div className="legal-wrapper">
            ...
            <article className="legal-article">
              <section id="introduction" className="legal-section">
                <h2>Introduction</h2>
                <p>BetterCalauan.org (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) is committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.</p>
              ...
              <section id="data-sharing" className="legal-section">
                ...
                <ul className="legal-list">
                  ...
                  <li><strong>Protection of Rights:</strong> To protect the rights, property, or safety of BetterCalauan.org, our users, or the public</li>
              ...
              <section id="your-rights" className="legal-section">
                ...
                <div className="legal-callout">
                  ...
                  <p>To exercise any of these rights, please contact us at <a href="mailto:volunteer@bettercalauan.org">volunteer@bettercalauan.org</a>. We will respond to your request within 30 days as required by law.</p>
                </div>
              </section>

              <section id="childrens-privacy" className="legal-section">
                <h2>Children&apos;s Privacy</h2>
                <p>BetterCalauan.org is a general audience website providing civic information. We do not knowingly collect personal information from children under 18 years of age without parental consent.</p>
                <p>If you are a parent or guardian and believe your child has provided us with personal information, please contact us immediately at <a href="mailto:volunteer@bettercalauan.org">volunteer@bettercalauan.org</a>, and we will take steps to delete such information.</p>
              </section>
